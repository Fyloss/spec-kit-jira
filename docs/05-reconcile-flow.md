...
flowchart TD
    ...
    Avail -->|"yes"| Route["1 · Resolve routing<br/>five ranks: rule → team prefix → the spec's own record → your team → default<br/>folder → project key, or an explicit override"]
