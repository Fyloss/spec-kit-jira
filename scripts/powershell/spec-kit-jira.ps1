...
$UsageLines = @(
    'usage: spec-kit-jira <config|reconcile|mention|feature|seed> [options]'
...
if ([string]::IsNullOrEmpty($command)) {
    [Console]::Error.WriteLine('spec-kit-jira: a command is required (config|reconcile|mention|feature|seed)')
    [Console]::Error.Write($UsageText)
