...
BeforeAll {
    ...
    $script:Doc = '{"routing":{"project_key":"COMP"},"stories":[{"local_id":"s1","title":"A story","description":{"blocks":[{"type":"paragraph","text":"need"}]},"acceptance_criteria":[{"given":["g"],"when":["w"],"then":["t"]}],"priority_logical":"P1","estimation":5}]}'
